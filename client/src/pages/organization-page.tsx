...
export default function OrganizationPage() {
  ...
  const updateOrgMutation = useMutation({
    mutationFn: async (updatedData: Partial<Organization>) => {
      const res = await apiRequest('PATCH', `/api/organizations/${organization?.id}`, updatedData);
      return await res.json();
    },
    onSuccess: (updatedOrg) => {
      queryClient.setQueryData(['/api/organizations', user?.organizationId], updatedOrg);
      toast({
    ...
    onError: (error: Error) => {
      toast({
        title: "Fout",
        description: error.message || "Er is een fout opgetreden bij het bijwerken van de organisatie.",
        variant: "destructive"
      });
    }
  });
  ...
  const handleLogoUpload = async (event: React.FormEvent) => {
    ...
    try {
      ...
      queryClient.setQueryData(['/api/organizations', user?.organizationId], data.organization);
      ...
      <div className="container mx-auto py-10">
        <Card className="max-w-lg mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Je bent nog niet toegewezen aan een organisatie. Neem contact op met een beheerder om toegang te krijgen.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
      ...
      <Tabs defaultValue="general">
        ...
        <TabsContent value="general">
          <Card>
                ...
                <div className="grid gap-6 mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="grid gap-3">
                      ...
                      <Input id="zipCode" name="zipCode" defaultValue={organization?.zipCode || ''} />
                    </div>
                  </div>
            ...
            <CardFooter>
              <Button type="submit" form="generalForm" disabled={updateOrgMutation.isPending}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload het logo van je organisatie. Dit logo wordt ook gebruikt in PDF documenten.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="mb-4">
                ...
                <form onSubmit={handleLogoUpload} className="space-y-4">
                  ...
                  >
                    {isUploading ? (
                      <CarLoading size="sm" type="spinner" text="Uploaden..." />
                    ) : "Logo uploaden"}
                  </Button>
                </form>
              </CardContent>
            ...
            <Card>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="grid gap-3">
                        ...
                        <div className="flex">
                          ...
                          <div 
                            ...
                            style={{ backgroundColor: organization?.pdfPrimaryColor || "#4a6da7" }} 
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid gap-3">
                        ...
                        <div className="flex">
                          ...
                          <div 
                            className="w-10 border border-l-0 rounded-r-md" 
                            style={{ backgroundColor: organization?.pdfSecondaryColor || "#333333" }} 
                          />
                        </div>
                      </div>
                    </div>
              ...
              <CardFooter>
                <Button type="submit" form="pdfForm" disabled={updateOrgMutation.isPending}>
                  {updateOrgMutation.isPending ? (
                    <CarLoading size="sm" type="spinner" text="Opslaan..." />
                  ) : "Opslaan"}
                </Button>
